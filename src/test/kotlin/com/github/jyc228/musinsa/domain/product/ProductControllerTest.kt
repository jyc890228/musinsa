...
class ProductControllerTest : IntegrationTest() {
    ...
    fun `product 를 수정할 수 있다`() {
        val pid = client.createProduct(brandId, 2, 1000.toBigInteger())

        shouldNotThrowAny { client.updateProduct(pid, brandId, 2, 2000.toBigInteger()) }
        shouldNotThrowAny { client.updateProduct(pid, brandId, 3, 2000.toBigInteger()) }
